...
class Users(db.Model, UserMixin):
    ...
    def get_reset_token(self, expires_sec:int=1800):
        ...
        token_bytes  = jwt.encode(header, payload, key_bytes)
    ...
    def verify_reset_token(self, token_string :str) -> 'Users':
        ...
        try:
            payload = jwt.decode(token_string, self._get_reset_token_key())
            payload.validate()

        except (
            jwt.errors.DecodeError,
            jwt.errors.ExpiredTokenError,
            jwt.errors.BadSignatureError,
        ):
            return False
